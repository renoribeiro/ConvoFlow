...
export const FEATURE_HELP: Record<string, FeatureHelpEntry> = {
  ...
  'page:dashboard': {
    ...
    tips: [
      ...
      'Gerente: ao escolher uma Loja no seletor, os dados dela aparecem para leitura — conversas, contatos, funil, campanhas. Você acompanha tudo, mas quem responde e edita no dia a dia é o Gestor daquela Loja.',
    ],
    category: 'tela',
    area: 'Operação',
  },
  'page:conversations': {
    ...
    tips: [
      ...
      'Gerente vê as conversas das Lojas da própria Conta escolhendo a Loja no seletor do topo, mas só para leitura: o histórico abre, e o campo de resposta não envia. Responder é do Gestor e do Atendente daquela Loja.',
