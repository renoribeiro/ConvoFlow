...
export const FEATURE_HELP: Record<string, FeatureHelpEntry> = {
  ...
  'page:conversations': {
    ...
    tips: [
      ...
      'Conversa do Instagram responde só pelo Instagram. Se a conexão do Instagram não estiver disponível ou tiver expirado, o campo trava e diz o motivo: a mensagem nunca sai pelo WhatsApp da Loja. Conexão expirada é com o administrador, que reconecta a conta do Instagram.',
      'Resposta dada pelo app do Instagram no celular também aparece aqui, sem autor. A que você manda por esta tela aparece uma vez só, com o seu nome.',
    ],
    category: 'tela',
    area: 'Operação',
  },
